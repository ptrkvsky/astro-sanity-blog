...
description: Une introduction sur les core webvitals pour avoir une vue d'ensemble des différents indicateurs de performance web (FCP, TTFB, Speed Index, etc.)
image: '/images/google.jpg'
isHome: false
slug: 'core-web-vitals-introduction'
title: Bien comprendre les core webvitals
metaTitle: Améliorez vos Core Web Vitals et l'expérience utilisateur de votre site internet avec ces conseils.
metaDescription: 'Informations et conseils pour bien comprendre les core webvitals et améliorer les performances votre site web. Vos visiteurs auront ainsi une meilleure expérience utilisateur.'
---

import { Image } from '@astrojs/image/components';
import banner from '@assets/images/google.jpg';
import scoreLighthouse from '@assets/images/score-light-house.png';
import badLighthouse from '@assets/images/bad-lighthouse.png';
...
<Image
  alt={`Mauvais score Core Web Vitals`}
  src={badLighthouse}
  width={990}
  height={964}
  format="avif"
...
Consulter mon article <a href="https://developpeur-web.tech/posts/comment-reduire-ttfb">comment réduire le TTFB (Time to first byte)</a> pour plus d'informations
...
<a href="/">Johan Petrikovsky développeur React Freelance</a>
